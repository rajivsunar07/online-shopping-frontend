                                ...
                                <div className="card">
                                    <div className="card-body">
                                        <div className="d-flex flex-column align-items-center text-center">
                                            <img src={ `http://localhost:5000/${this.state.image}` } alt="Admin" className="rounded-circle" width="150" />
                                            <div className="mt-3">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="row">
                                            <div className="col-sm-12">
                                                <Link className="btn btn-info " to={ `/profile/update/${this.state._id}`} >Update</Link>
                                                <Link className="btn btn-info " to={ `/profile/password/`} >Change Password</Link>
